...
from lerobot.robots.dobot_nova5.config_xense_gripper import GripperConfig
...
class Gripper:
    ...
    def __init__(self, config: GripperConfig):
        ...
        self._gripper_velocity = config.gripper_velocity
    ...
    def set_gripper_position(self, normalized_pos: float) -> None:
        ...
        self._gripper.set_position(target_pos, vmax=self._gripper_velocity, fmax=self._gripper_force)
