...
class FrankaResearch3Config(RobotConfig):
    ...
    # control_mode: str = "joint_position"  # Options: joint_position, cartesian_position
    control_mode: ControlMode = ControlMode.JOINT_IMPEDANCE
    ...
    # Dynamics factor for safe operation (0.05-0.5)
    # Lower = slower/safer, Higher = faster/more responsive
